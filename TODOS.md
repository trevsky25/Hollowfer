...
**Status snapshot (2026-07-12):** **Acts I–III COMPLETE** — 23 quests live and bridge-verified. Act III B shipped end-to-end (batches 19/21/22/23: chapel reconcile, apprentice, choice-UI debut `theoCapitalOffer`, festival, `aldricLetter` → `act3_complete`); batch-20 made all 20 species real. **Next: item 10/11 infra (review personas / visual-regression) OR Act IV (item 12, `aldricOfferRead` — FABLE-GATED) + ending engine (item 13, FABLE-GATED).** Accrued: an "Act III staging pass" (Theo→inn, festival→square, Voss→mill door — all deferred NPC placements). Open: Q5 (Wren journal), Q6 (festival cook/gather).
