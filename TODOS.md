...
**Status snapshot (2026-07-12):** Acts I–III complete; **Act IV STARTED** — 24 quests live and bridge-verified. Act III B shipped (batches 19/21/22/23); batch-20 made all 20 species real; **batch-24** opened Act IV (`aldricOfferRead` — Wren reads Aldric's offer at the mill; `act4_started`). batch-25 added Act IV "consult the village about Aldric" (Bram/Almy/Hollin). **Next: Act IV scene 2 `wendSource` — BLOCKED on Q7** (Aldermark must map to a real mushroom, your call), then scene 3 `meetAldric` + the ending engine (FABLE-GATED, canon-critical — recommend your direct involvement). Accrued: an "Act III staging pass" (Theo/festival/Voss placements). Open: Q5 (Wren journal), Q6 (festival cook/gather), Q7 (Aldermark species — blocks wendSource).
...
12. **Act IV (scenes 1–3, quests 24–26 of the endgame)** — FABLE-REVIEW GATE (canon-critical endgame).
   ...
   - **scene 2 `wendSource`** — the upstream clear-cut (new location) + Aldermark species (new) + Hollin; evidence-gathering, Knowledge +15. Mechanical/lower-stakes — good autonomous next.
   - **scene 3 `meetAldric`** — NPC_Aldric (first physical, needs model/placeholder + manor location) at the negotiation; the final-choice trigger. Canon-heavy — wants Trevor.
