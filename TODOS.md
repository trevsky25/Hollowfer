...
**Status snapshot (2026-07-12):** 22 of ~23 quests live and bridge-verified. Act III A (batch-18) + Act III B scenes 4–7 shipped (batch-19 `caldenReconcile`/`eddaApprentice`; batch-21 `theoCapitalOffer` — choice-UI debut, fable-reviewed; batch-22 `festivalHosted`); batch-20 made all 20 field-guide species real. **Next: Act III B 9d `aldricLetter` → `act3_complete`** (Voss delivers the letter; closes Act III). Open: Q5 (Wren journal), Q6 (festival cook/gather scope).
