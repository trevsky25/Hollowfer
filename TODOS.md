...
**Status snapshot (2026-07-12):** Acts I–III complete; **Act IV STARTED** — 24 quests live and bridge-verified. Act III B shipped (batches 19/21/22/23); batch-20 made all 20 species real; **batch-24** opened Act IV (`aldricOfferRead` — Wren reads Aldric's offer at the mill; `act4_started`). **Next: Act IV scene 2 `wendSource`** (clear-cut + Aldermark; mechanical) then scene 3 `meetAldric` + the ending engine (both FABLE-GATED, canon-critical — recommend Trevor's direct involvement). Accrued: an "Act III staging pass" (Theo/festival/Voss placements). Open: Q5 (Wren journal), Q6 (festival cook/gather).
