...
**Status snapshot (2026-07-12):** Acts I–III complete; **Act IV scenes 1–2 shipped** — 25 quests live and bridge-verified. Act III B (batches 19/21/22/23) + batch-20 (all species real) + Act IV: batch-24 `aldricOfferRead` (`act4_started`), batch-25 consult-the-village, batch-26 `wendSource` (clear-cut, Aldermark = real Grifola frondosa, Knowledge +15). **Next: Act IV scene 3 `meetAldric`** (NPC_Aldric + manor → the final-choice trigger) then the **ending engine** (item 13) — both canon-critical, recommend your direct authorship. Growing: an "Act III–IV staging + world-dressing pass" (Theo/festival/Voss/Hollin placements, clear-cut dressing, Aldermark node+photo). Open: Q8 (Aldermark seedbook attribution — low-stakes veto).
