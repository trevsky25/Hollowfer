...
namespace Hollowfen.Quests
{
    ...
    public class QuestHUD : MonoBehaviour
    {
        ...
        private void BuildIfNeeded()
        {
            ...
            _eyebrow = UICanvasUtil.NewEyebrow("Eyebrow", rt, "QUEST  ·  ACT I", 12.5f, HollowfenPalette.Gold, TextAlignmentOptions.TopLeft);
            ...
            eRT.sizeDelta = new Vector2(-36f, 17f);
            eRT.anchoredPosition = new Vector2(18f, -11f);
            ...
            nRT.anchoredPosition = new Vector2(18f, -30f);

            _objective = UICanvasUtil.NewBody("Objective", rt, "", 16f, HollowfenPalette.Parchment, FontStyles.Italic, TextAlignmentOptions.TopLeft);
            ...
            oRT.sizeDelta = new Vector2(-36f, _panelHeight - 60f);
            oRT.anchoredPosition = new Vector2(18f, -60f);
        }
    }
}
