...
namespace Hollowfen.GameTime
{
    ...
    public sealed class DayNightLighting : MonoBehaviour
    {
        ...
        {
            S(0f,   28f, 180f, .11f, C(.43f,.56f,.88f), C(.055f,.08f,.14f), C(.035f,.05f,.085f), C(.018f,.023f,.038f), .52f, C(.022f,.038f,.07f), .0145f, .22f, .16f, C(.32f,.40f,.58f), C(.018f,.028f,.05f), .55f, -.58f, 16f, -13f, -8f, C(.72f,.82f,1f), .35f, 1f),
            S(5f,   24f, 180f, .10f, C(.42f,.54f,.86f), C(.05f,.075f,.13f), C(.032f,.047f,.08f), C(.016f,.022f,.036f), .50f, C(.02f,.036f,.066f), .015f, .20f, .14f, C(.30f,.38f,.56f), C(.016f,.026f,.046f), .52f, -.62f, 17f, -14f, -9f, C(.70f,.81f,1f), .36f, 1f),
            ...
            S(20.5f,28f, 180f, .11f, C(.43f,.56f,.88f), C(.055f,.08f,.14f), C(.035f,.05f,.085f), C(.018f,.023f,.038f), .52f, C(.022f,.038f,.07f), .0145f, .22f, .16f, C(.32f,.40f,.58f), C(.018f,.028f,.05f), .55f, -.58f, 16f, -13f, -8f, C(.72f,.82f,1f), .35f, 1f),
            S(24f,  28f, 180f, .11f, C(.43f,.56f,.88f), C(.055f,.08f,.14f), C(.035f,.05f,.085f), C(.018f,.023f,.038f), .52f, C(.022f,.038f,.07f), .0145f, .22f, .16f, C(.32f,.40f,.58f), C(.018f,.028f,.05f), .55f, -.58f, 16f, -13f, -8f, C(.72f,.82f,1f), .35f, 1f),
        };
        ...
        public void Apply(float hour)
        {
            ...
            if (_keyLight != null)
            {
                ...
                _keyLight.color = Color.Lerp(a.KeyColor, b.KeyColor, t);
            }
            ...
            RenderSettings.fogDensity = CurrentFogDensity = L(a.FogDensity, b.FogDensity, t);
            ...
            SetSkyboxColor("_SkyTint", Color.Lerp(a.SkyTint, b.SkyTint, t));
