...
- Current use (Batch 11): one instance in `Scene_Hollowfen` with `knife_commissioned → knife_ready` (Joren's overnight forging; consumed by `NPC_Joren` entry conditions).
